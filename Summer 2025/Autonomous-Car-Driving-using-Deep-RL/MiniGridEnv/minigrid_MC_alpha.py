...
def every_visit_mc_control(env, episodes, gamma,alpha, epsilon,epsilon_min=0.001, epsilon_decay=0.99):
...
Q, policy , rewards, steps = every_visit_mc_control(env,alpha=0.3, episodes=1000, gamma=0.99, epsilon=1.0)
